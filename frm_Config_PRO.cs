...
{
    public partial class frm_Config_PRO : Form
    {
        public frm_Config_PRO()
        {
            InitializeComponent();
        }
        ...
        private void frmConfig_Load(object sender, EventArgs e)
        {
            ...
            loadConfigLD();
            string[] appfb = { "Facebook 299", "Facebook 251", "Facebook 302" };
        ...
        public void saveConfigLD()
        {
            try
            {
                ...
                SettingTool.configld.apiTMproxy = txtTmproxy.Text.Trim();
                ...
                SettingTool.configld.cpu = cboCpu.Text.Trim();
                SettingTool.configld.ram = cboRam.Text.Trim();
        ...
        private void loadConfigLD()
        {
            try
            {
                ...
                chkCheckProxy.Checked = SettingTool.configld.checkproxy;
                 ...
                 cboCpu.Text = SettingTool.configld.cpu ;
                 cboRam.Text = SettingTool.configld.ram ;
        ...
        public void method_SaveTuongTacNgay(int id)
        {
            ...
            settingtuongtac.chkaddfriendlink = chkaddfriendlink.Checked;
            settingtuongtac.numaddfriendlinkmin = (int)numaddfriendlinkmin.Value;
            settingtuongtac.numaddfriendlinkmax = (int)numaddfriendlinkmax.Value;
            settingtuongtac.txtfilelink = txtfilelink.Text;
            ...
            settingtuongtac.timeviewvideomin = (int)numviewvideomin.Value;
            settingtuongtac.timeviewvideomax = (int)numviewvideomax.Value;
        ...
        private void method_LoadTuongTacNgay(int id)
        {
            try
            {
                ...
                numviewvideomin.Value =  settingtuongtac.timeviewvideomin;
                numviewvideomax.Value = settingtuongtac.timeviewvideomax ;
                ...
                chkaddfriendlink.Checked = settingtuongtac.chkaddfriendlink;
                numaddfriendlinkmin.Value = settingtuongtac.numaddfriendlinkmin;
                numaddfriendlinkmax.Value = settingtuongtac.numaddfriendlinkmax ;
                txtfilelink.Text  = settingtuongtac.txtfilelink;
        ...
        private void setupLanguage()
        {
            ...
            label8.Text = "Post /1 time";
            label10.Text = "Post /1 time";
            label3.Text = "Page /1 time";
        ...
        private void bunifuFlatButton7_Click(object sender, EventArgs e)
        {
            ...
            if (fldrDlg.ShowDialog() == DialogResult.OK)
            {
                txtPathData.Text = fldrDlg.SelectedPath;
            }
        }
        ...
        private void btnfileLink_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                txtfilelink.Text = dialog.FileName;
            }
        }
