...
{
    public partial class frm_DNSInfo : Form
    {
        public frm_DNSInfo(List<DetailLDModel> list_detail, frm_MainLD frm)
        {
            InitializeComponent();
        ...
        private void runsetProxy(DataGridViewRow dr, CancellationToken token)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (ld.setProxyAuthentica_proxydroid(ldID, proxy, token))
                    {
        ...
        private void frmDNSInfo_Load(object sender, EventArgs e)
        {
