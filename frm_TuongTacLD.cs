...
{
    public partial class frm_TuongTacLD : Form
    {
        public frm_TuongTacLD(List<Account> list_acc, frm_MainLD frm_main)
        {
            InitializeComponent();
        ...
        private bool setupCauHinh()
        {
            try
            {
                ...
                if (cboConfig.Text == "Ngẫu Nhiên" || cboConfig.Text == "")
                {
                    ...
                    tuongtac.numlikenewfeedmax = rd.Next(tuongtac.numlikenewfeedmin, tuongtac.numlikenewfeedmin + 5);
                    tuongtac.numcommentnewfeedmin = rdom.Next(1, 5);
                    tuongtac.numcommentnewfeedmax = rdom.Next(tuongtac.numcommentnewfeedmin, tuongtac.numcommentnewfeedmin + 5);
                    tuongtac.message = "{Hi|Xin chao|aloha|bonjour|arigato|xiaxia|ciao}";

                    tuongtac.numsharevideo = rdom.Next(1, 3);

                    tuongtac.numsharepostmin = rdom.Next(1, 3);
                    tuongtac.numsharepostmax = rdom.Next(tuongtac.numsharepostmin, tuongtac.numsharepostmin + 3);
                    tuongtac.strkeywordfanpage = "lam dep, thoi trang, cong nghe, am thuc, nau an";
                    tuongtac.numlikefanpagemin = rdom.Next(1, 5);
                    tuongtac.numlikefanpagemax = rdom.Next(5, 10);
                    ...
                    tuongtac.numaddfriendmax = rdom.Next(5, 10);
                    tuongtac.numaddfriendNewfeedmin = rdom.Next(1, 5);
                    tuongtac.numaddfriendNewfeedmax = rdom.Next(5, 10);
                    tuongtac.numacceptfriendmin = rdom.Next(1, 5);
                    tuongtac.numacceptfriendmax = rdom.Next(5, 10);
                    tuongtac.strkeywordseach = "lam dep, thoi trang, cong nghe, am thuc, nau an";
                    tuongtac.numjoingroupkeywordmin = rdom.Next(1, 5);
                    tuongtac.numjoingroupkeywordmax = rdom.Next(5, 10);
                    tuongtac.numlikepostgroupmin = rdom.Next(1, 5);
                    tuongtac.numlikepostgroupmax = rdom.Next(5, 10);
                    tuongtac.numcommentpostgroupmin = rdom.Next(1, 5);
                    tuongtac.numcommentpostgroupmax = rdom.Next(5, 10);
                ...
                if (tuongtac.chkcommentImage)
                {
                    list_tuongtac.Add(43);
                }
                //comment image group
                if (tuongtac.chkcommentImage_gr)
                {
                    list_tuongtac.Add(44);
                }
                ...
                if (list_acc.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        if (dr != null)
                        {
                            ...
                            try
                            {
                                u.setStatus(ldID, "Open Facebook...");
                            ...
                            else
                            {
                                    ...
                                    for (int i = 0; i < tuongtac.action; i++)
                                    {
                                        ...
                                        switch (type)
                                        {
                                            ...
                                            case 6:
                                                ...
                                                if (File.Exists(tuongtac.strkeywordfanpage))
                                                {
                                                    //string pageid = list_page[rd.Next(0, list_page.Count)];
                                                    //dr.Cells["Message"].Value = "Like Post Fanpage";
                                                    //message += ld.scrollLikePostPage(u, acc, ldID, acc.app, pageid, tuongtac.numlikepostfanpagemin, tuongtac.numlikepostfanpagemax, token);

                                                    List<string> list_page = new List<string>();
                                                    list_page = File.ReadLines(tuongtac.strkeywordfanpage).ToList();
                                                    ...
                                                    {
                                                        u.setStatus(ldID, "Vui lòng điền id fanpage vào file txt...");
                                                    }
                                                }
                                                else
                                                {
                                            ...
                                            case 7:
                                                ...
                                                if (File.Exists(tuongtac.strkeywordfanpage))
                                                {
                                                    ...
                                                    if (list_page.Count > 0)
                                                    {
                                                        ...
                                                        if (File.Exists(tuongtac.message))
                                                            message += ld.scrollCommentPostPage(u, acc, ldID, acc.app, pageid, tuongtac.numcommentpostfanpagemin, tuongtac.numcommentpostfanpagemax, File.ReadAllText(tuongtac.message), token);
                                                        else
                                                        {
                                                            if (SettingTool.configld.language == "English")
                                                                message += "No comment content set";
                                            ...
                                            case 18:
                                                ...
                                                int luot = rd.Next(tuongtac.numGroupUIDMin, tuongtac.numGroupUIDMax);
                                            ...
                                            Lb_FinishAcc:
                                                ...
                                                message += "| Join group by ID complete" + count.ToString() + "/" + luot.ToString();
                                                break;
                                            ...
                                            case 21:
                                                ...
                                                if (tuongtac.pathGroupIdLikecomment != "")
                                                {
                                                    if (File.Exists(tuongtac.pathGroupIdLikecomment))
                                                    {
                                                        ...
                                                        {
                                                            comment = File.ReadAllText(tuongtac.strPathCommentGroup);
                                                            message += ld.likecommentID(u, acc, dr, ldID, acc.app, tuongtac.numlikepostgroupmin, tuongtac.numcommentpostgroupmax, true, true, lsId.ToList(), comment, 2, delay, false, token);
                                                        }
                                                        else
                                                        {
                                                            if (SettingTool.configld.language == "English")
                                            ...
                                            case 22:
                                                ...
                                                {
                                                    path = Application.StartupPath + "\\app\\Messenger.apk";
                                                    if (File.Exists(path))
                                                    {
                                            ...
                                            case 24:
                                                ...
                                                ld.scrollNewfeedWatch(u, ldID, acc, tuongtac.timenewfeedwatchmin, tuongtac.timenewfeedwatchmax, token);
                                            ...
                                            case 27:
                                                ...
                                                break;
                                            case 28:
                                                u.setStatus(ldID, "like bài viết trong group...");
                                                dr.Cells["Message"].Value = "like bài viết trong group";
                                                ...
                                                if (Directory.Exists(pathpostprofile))
                                                {
                                                    ...
                                                    if (list_path.Count > 0)
                                                    {
                                                        if (totalpostprofile >= tuongtac.postprofile_maxday)
                                                        {
                                                            if (SettingTool.configld.language == "English")
                                                            {
                                                                u.setStatus(ldID, "Post enough posts in a day...");
                                                                dr.Cells["Message"].Value = "Post enough posts in a day";
                                                            }
                                                            else
                                                            {
                                                                u.setStatus(ldID, "Đã đăng Profile đủ số bài trong ngày...");
                                                                dr.Cells["Message"].Value = "Đã đăng Profile đủ số bài trong ngày";
                                                                message += "|Đã đăng Profile đủ số bài trong ngày";
                                                            }
                                                        }
                                                        else
                                                        {
                                            ...
                                            case 34:
                                                ...
                                                int maxerror = 0;
                                                int countUnfriend = 0;
                                                int int_luot = rd.Next(tuongtac.numcancelfrienduidmin, tuongtac.numcancelfrienduidmax);
                                                u.setStatusSum(int_luot);
                                                ...
                                                message += " |Hủy kết bạn hoàn thành:" + countUnfriend.ToString() + "/" + int_luot.ToString();
                                                #endregion
                                                break;
                                            case 35:
                                                ...
                                                int max = 0;
                                                int count_rd = 0;
                                                int int_huykbrandom = rd.Next(tuongtac.numcancelfrienduidmin, tuongtac.numcancelfrienduidmax);
                                                u.setStatusSum(int_huykbrandom);
                                                ...
                                                {
                                                    count_rd = ld.unfriendManual(acc, int_huykbrandom, token);
                                                }

                                                message += " |Hủy kết bạn random hoàn thành:" + count_rd.ToString() + "/" + int_huykbrandom.ToString();
                                                #endregion
                                                break;
                                            case 36:
                                                if (SettingTool.configld.language == "English")
                                            ...
                                            case 43:
                                                if (SettingTool.configld.language == "English")
                                                {
                                                    u.setStatus(ldID, " |Comment with image ...");
                                                    dr.Cells["Message"].Value = " |Comment with image...";
                                                }
                                                else
                                                {
                                                    u.setStatus(ldID, " |Comment bằng ảnh...");
                                                    dr.Cells["Message"].Value = "|Comment bằng ảnh ";
                                                }
                                                if (Directory.Exists(tuongtac.pathImagecomment))
                                                {
                                                    List<string> list_file_image = new List<string>();
                                                    list_file_image = System.IO.Directory.GetFiles(tuongtac.pathImagecomment, "*.*").ToList();
                                                    if (list_file_image.Count > 0)
                                                    {
                                                        // result = ld.PostImages(acc.ldid, acc.app, content, list_file, (int)numPhoto.Value, token, removepic, rdAllFile.Checked);
                                                        int numcontentimage = rd.Next(tuongtac.numcommentImage, tuongtac.numcommentImage_max);
                                                        message += ld.scrollCommentNewFeedbyImage(u, acc, ldID, acc.app, numcontentimage, File.ReadAllText(tuongtac.message), token, list_file_image, tuongtac.chkdelcommentImage, 1, tuongtac.chkcontentImage, delay);
                                                    }
                                                }
                                                else
                                                {
                                                    if (SettingTool.configld.language == "English")
                                                        message += "No image content set";
                                                    else
                                                        message += "Chưa thiết lập image comment";
                                                }
                                                break;
                                            ...
                                            case 44:
                                                if (SettingTool.configld.language == "English")
                                                {
                                                    u.setStatus(ldID, " |Comment with image group newfeed ...");
                                                    dr.Cells["Message"].Value = " |Comment with image group newfeed...";
                                                }
                                                else
                                                {
                                                    u.setStatus(ldID, " |Comment group newfeed bằng ảnh...");
                                                    dr.Cells["Message"].Value = "|Comment group newfeed bằng ảnh ";
                                                }
                                                if (Directory.Exists(tuongtac.pathImagecomment_gr))
                                                {
                                                    List<string> list_file_image = new List<string>();
                                                    list_file_image = System.IO.Directory.GetFiles(tuongtac.pathImagecomment_gr, "*.*").ToList();
                                                    if (list_file_image.Count > 0)
                                                    {
                                                        // result = ld.PostImages(acc.ldid, acc.app, content, list_file, (int)numPhoto.Value, token, removepic, rdAllFile.Checked);
                                                        int numcontentimage = rd.Next(tuongtac.numcommentImage_gr, tuongtac.numcommentImage_max_gr);
                                                        message += ld.scrollCommentNewFeedbyImage(u, acc, ldID, acc.app, numcontentimage, File.ReadAllText(tuongtac.strPathCommentGroup), token, list_file_image, tuongtac.chkdelcommentImage_gr, 1, tuongtac.chkcontentImage_gr, delay, 1, true);
                                                    }
                                                }
                                                else
                                                {
                                ...
                                else
                                {
                                    ...
                                    {
                                        if (acc.Thongbao == "Login Successful" || acc.Thongbao == "Đăng nhập thành công" || acc.Thongbao.Contains("Check UID fail"))
                                        {
        ...
        private void tuongtacLite(userLD u, Account acc, DataGridViewRow dr, CancellationToken token)
        {
            NguoiDung_Bll nguoidung = new NguoiDung_Bll();
            ...
            for (int i = 0; i < tuongtac.action; i++)
            {
                if (token.IsCancellationRequested)
                    break;
                ld.activeNewfeed(acc.ldid, "com.facebook.lite");
                ...
                switch (type)
                {
                    case 1:
                        ...
                        dr.Cells["Message"].Value = "Scroll Newfeed";
                        ld.activeNewfeed(ldID, acc.app);
                        lite.scrollNewfeed(u, ldID, acc, tuongtac.numslidemin, tuongtac.numslidemax, token);
                        message += "| Scroll newfeed complete";
                        break;
                    case 2:
                        u.setStatus(ldID, "Like Newfeed...");
                        dr.Cells["Message"].Value = "Like Newfeed";
                        message += lite.scrollLikeNewFeed(u, acc, ldID, acc.app, tuongtac.numlikenewfeedmin, tuongtac.numlikenewfeedmax, tuongtac, token);
                        break;
                    case 3:
                        u.setStatus(ldID, "Comment Newfeed...");
                        dr.Cells["Message"].Value = "Comment Newfeed";
                    ...
                    case 6:
                        ...
                        if (File.Exists(tuongtac.strkeywordfanpage))
                        {
                            ...
                            if (list_page.Count > 0)
                            {
                                string pageid = list_page[rd.Next(0, list_page.Count)];
                                dr.Cells["Message"].Value = "Like Post Fanpage";
                                message += ld.scrollLikePostPage(u, acc, ldID, acc.app, pageid, tuongtac.numlikefanpagemin, tuongtac.numlikefanpagemax, token);
                            }
                            else
                            {
                                u.setStatus(ldID, "Vui lòng điền id fanpage vào file txt...");
